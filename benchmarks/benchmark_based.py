...
@triton.testing.perf_report(
    triton.testing.Benchmark(
        ...
        line_arg='provider',
        line_vals=['fused_chunk', 'torch', 'parallel',
                   'fused_chunk_bwd', 'torch_bwd', 'parallel_bwd'] + (['flash', 'flash_bwd'] if HAS_FLASH else []),
        # label name for the lines
        line_names=['fused_chunk_fwd', 'torch_fwd', 'parallel_fwd', 'fused_chunk_fwdbwd',
                    'torch_fwdbwd', 'parallel_fwdbwd'] + (['flash_fwd', 'flash_fwdbwd'] if HAS_FLASH else []),
        # line styles
